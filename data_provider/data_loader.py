...
class Dataset_ETT_ms(Dataset):
    ...
    def __read_data__(self):
        ...
        df_raw = pd.read_csv(
            os.path.join(self.root_path,  # (124416, 3), row=一共多少个“ms points”，column=3，"date, slice.num, value"
                         self.data_path))
        ...
        df_stamp = df_raw[['date']][
                   border1:border2]           # train=(99532, 1); dev=(13594, 1); test=(13594, 1). 关于date的信息，精确到了yyyy-mm-dd hh:mm:ss.575000
        ...
        #                            freq=self.freq)  # train=[99532, 7]; dev=(13594, 7); test=(13594, 7), 用7个特征值来表示一个时间点(to ms)
